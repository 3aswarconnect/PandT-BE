...
const { createJob, getJobs, getJobById, applyToJob, handleApplication,submitRating ,submitComment ,decreaseMoney,increaseMoney, getMyJobs, getMyApplications, completeJob,deleteJob,updateJob,getWorkerJobs,verfityotp } = require('../controllers/jobController');
